...
SaveManager.Folder = "SpiemUISettings"
SaveManager.Ignore = {}
...
function SaveManager:Load(name)
    ...
    for _, option in next, decoded.objects do
        if self.Parser[option.type] then
            task.spawn(function() 
                self.Parser[option.type].Load(option.idx, option, self.Options) 
            end)
        end
    end
...
function SaveManager:BuildConfigSection(tab)
    ...
    section:AddInput("SaveManager_ConfigName", { Title = "Config name", Placeholder = "Enter config name..." })
    ...
    section:AddButton({
        ...
        Callback = function()
            ...
            self.Options.SaveManager_ConfigList:SetValue(nil)
        end
    })
    ...
    section:AddButton({
        ...
        Description = "Overwrite selected config with current settings",
        Callback = function()
            local name = self.Options.SaveManager_ConfigList.Value
